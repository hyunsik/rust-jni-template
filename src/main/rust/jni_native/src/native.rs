...
pub struct JNINativeInterface {
  ...
  pub DefineClass: extern "C" fn(env: *mut JNIEnv, name: *const ::libc::c_char,
      loader: jobject, buf: *const jbyte, len: jsize) -> jclass, // may throw
  ...
  pub Throw:              extern "C" fn(env: *mut JNIEnv, obj: jthrowable) -> JniError, // throws
  pub ThrowNew:           extern "C" fn(env: *mut JNIEnv, clazz: jclass, msg: *const ::libc::c_char) -> JniError, // throws
  ...
  pub EnsureLocalCapacity:    extern "C" fn(env: *mut JNIEnv, capacity: jint) -> JniError, // may throw
  ...
  pub NewObjectV:     extern "C" fn(env: *mut JNIEnv, clazz: jclass, methodID: jmethodID, self::Empty) -> jobject,
  pub NewObjectA:     extern "C" fn(env: *mut JNIEnv, clazz: jclass, methodID: jmethodID, args: *const jvalue) -> jobject,
  ...
  /// may throw
  pub GetMethodID:    extern "C" fn(env: *mut JNIEnv, clazz: jclass, name: *const ::libc::c_char, sig: *const ::libc::c_char) -> jmethodID,

  /// these all may throw
  pub CallObjectMethod:   extern "C" fn(env: *mut JNIEnv, obj: jobject, methodID: jmethodID, ...) -> jobject,
  pub CallObjectMethodV:  extern "C" fn(env: *mut JNIEnv, obj: jobject, methodID: jmethodID, args: self::Empty) -> jobject,
  ...
  pub CallBooleanMethodV: extern "C" fn(env: *mut JNIEnv, obj: jobject, methodID: jmethodID, args: self::Empty) -> jboolean,
  ...
  pub CallByteMethodV:    extern "C" fn(env: *mut JNIEnv, obj: jobject, methodID: jmethodID, args: self::Empty) -> jbyte,
  ...
  pub CallCharMethodV:    extern "C" fn(env: *mut JNIEnv, obj: jobject, methodID: jmethodID, args: self::Empty) -> jchar,
  ...
  pub CallShortMethodV:   extern "C" fn(env: *mut JNIEnv, obj: jobject, methodID: jmethodID, args: self::Empty) -> jshort,
  ...
  pub CallIntMethodV:     extern "C" fn(env: *mut JNIEnv, obj: jobject, methodID: jmethodID, args: self::Empty) -> jint,
  ...
  pub CallLongMethodV:    extern "C" fn(env: *mut JNIEnv, obj: jobject, methodID: jmethodID, args: self::Empty) -> jlong,
  ...
  pub CallFloatMethodV:   extern "C" fn(env: *mut JNIEnv, obj: jobject, methodID: jmethodID, args: self::Empty) -> jfloat,
  ...
  pub CallDoubleMethodV:  extern "C" fn(env: *mut JNIEnv, obj: jobject, methodID: jmethodID, args: self::Empty) -> jdouble,
  ...
  pub CallVoidMethodV:    extern "C" fn(env: *mut JNIEnv, obj: jobject, methodID: jmethodID, args: self::Empty),
  ...
  pub CallNonvirtualObjectMethodV:    extern "C" fn(env: *mut JNIEnv, obj: jobject, methodID: jmethodID, args: self::Empty) -> jobject,
  ...
  pub CallNonvirtualBooleanMethodV:   extern "C" fn(env: *mut JNIEnv, obj: jobject, methodID: jmethodID, args: self::Empty) -> jboolean,
  ...
  pub CallNonvirtualByteMethodV:      extern "C" fn(env: *mut JNIEnv, obj: jobject, methodID: jmethodID, args: self::Empty) -> jbyte,
  ...
  pub CallNonvirtualCharMethodV:      extern "C" fn(env: *mut JNIEnv, obj: jobject, methodID: jmethodID, args: self::Empty) -> jchar,
  ...
  pub CallNonvirtualShortMethodV:     extern "C" fn(env: *mut JNIEnv, obj: jobject, methodID: jmethodID, args: self::Empty) -> jshort,
  ...
  pub CallNonvirtualIntMethodV:       extern "C" fn(env: *mut JNIEnv, obj: jobject, methodID: jmethodID, args: self::Empty) -> jint,
  ...
  pub CallNonvirtualLongMethodV:      extern "C" fn(env: *mut JNIEnv, obj: jobject, methodID: jmethodID, args: self::Empty) -> jlong,
  ...
  pub CallNonvirtualFloatMethodV:     extern "C" fn(env: *mut JNIEnv, obj: jobject, methodID: jmethodID, args: self::Empty) -> jfloat,
  ...
  pub CallNonvirtualDoubleMethodV:    extern "C" fn(env: *mut JNIEnv, obj: jobject, methodID: jmethodID, args: self::Empty) -> jdouble,
  ...
  pub CallNonvirtualVoidMethodV:      extern "C" fn(env: *mut JNIEnv, obj: jobject, methodID: jmethodID, args: self::Empty),
  pub CallNonvirtualVoidMethodA:      extern "C" fn(env: *mut JNIEnv, obj: jobject, methodID: jmethodID, args: *const jvalue),

  /// may throw
  pub GetFieldID:         extern "C" fn(env: *mut JNIEnv, clazz: jclass, name: *const ::libc::c_char, sig: *const ::libc::c_char) -> jfieldID,
  ...
  /// may throw
  pub GetStaticMethodID:  extern "C" fn(env: *mut JNIEnv, clazz: jclass, name: *const ::libc::c_char, sig: *const ::libc::c_char) -> jmethodID,

  /// these all may throw
  pub CallStaticObjectMethod:     extern "C" fn(env: *mut JNIEnv, clazz: jclass, methodID: jmethodID, ...) -> jobject,
  pub CallStaticObjectMethodV:    extern "C" fn(env: *mut JNIEnv, clazz: jclass, methodID: jmethodID, args: self::Empty) -> jobject,
  pub CallStaticObjectMethodA:    extern "C" fn(env: *mut JNIEnv, clazz: jclass, methodID: jmethodID, args: *const jvalue) -> jobject,
  pub CallStaticBooleanMethod:    extern "C" fn(env: *mut JNIEnv, clazz: jclass, methodID: jmethodID, ...) -> jboolean,
  pub CallStaticBooleanMethodV:   extern "C" fn(env: *mut JNIEnv, clazz: jclass, methodID: jmethodID, args: self::Empty) -> jboolean,
  pub CallStaticBooleanMethodA:   extern "C" fn(env: *mut JNIEnv, clazz: jclass, methodID: jmethodID, args: *const jvalue) -> jboolean,
  pub CallStaticByteMethod:       extern "C" fn(env: *mut JNIEnv, clazz: jclass, methodID: jmethodID, ...) -> jbyte,
  pub CallStaticByteMethodV:      extern "C" fn(env: *mut JNIEnv, clazz: jclass, methodID: jmethodID, args: self::Empty) -> jbyte,
  pub CallStaticByteMethodA:      extern "C" fn(env: *mut JNIEnv, clazz: jclass, methodID: jmethodID, args: *const jvalue) -> jbyte,
  pub CallStaticCharMethod:       extern "C" fn(env: *mut JNIEnv, clazz: jclass, methodID: jmethodID, ...) -> jchar,
  pub CallStaticCharMethodV:      extern "C" fn(env: *mut JNIEnv, clazz: jclass, methodID: jmethodID, args: self::Empty) -> jchar,
  pub CallStaticCharMethodA:      extern "C" fn(env: *mut JNIEnv, clazz: jclass, methodID: jmethodID, args: *const jvalue) -> jchar,
  pub CallStaticShortMethod:      extern "C" fn(env: *mut JNIEnv, clazz: jclass, methodID: jmethodID, ...) -> jshort,
  pub CallStaticShortMethodV:     extern "C" fn(env: *mut JNIEnv, clazz: jclass, methodID: jmethodID, args: self::Empty) -> jshort,
  pub CallStaticShortMethodA:     extern "C" fn(env: *mut JNIEnv, clazz: jclass, methodID: jmethodID, args: *const jvalue) -> jshort,
  pub CallStaticIntMethod:        extern "C" fn(env: *mut JNIEnv, clazz: jclass, methodID: jmethodID, ...) -> jint,
  pub CallStaticIntMethodV:       extern "C" fn(env: *mut JNIEnv, clazz: jclass, methodID: jmethodID, args: self::Empty) -> jint,
  pub CallStaticIntMethodA:       extern "C" fn(env: *mut JNIEnv, clazz: jclass, methodID: jmethodID, args: *const jvalue) -> jint,
  pub CallStaticLongMethod:       extern "C" fn(env: *mut JNIEnv, clazz: jclass, methodID: jmethodID, ...) -> jlong,
  pub CallStaticLongMethodV:      extern "C" fn(env: *mut JNIEnv, clazz: jclass, methodID: jmethodID, args: self::Empty) -> jlong,
  pub CallStaticLongMethodA:      extern "C" fn(env: *mut JNIEnv, clazz: jclass, methodID: jmethodID, args: *const jvalue) -> jlong,
  pub CallStaticFloatMethod:      extern "C" fn(env: *mut JNIEnv, clazz: jclass, methodID: jmethodID, ...) -> jfloat,
  pub CallStaticFloatMethodV:     extern "C" fn(env: *mut JNIEnv, clazz: jclass, methodID: jmethodID, args: self::Empty) -> jfloat,
  pub CallStaticFloatMethodA:     extern "C" fn(env: *mut JNIEnv, clazz: jclass, methodID: jmethodID, args: *const jvalue) -> jfloat,
  pub CallStaticDoubleMethod:     extern "C" fn(env: *mut JNIEnv, clazz: jclass, methodID: jmethodID, ...) -> jdouble,
  pub CallStaticDoubleMethodV:    extern "C" fn(env: *mut JNIEnv, clazz: jclass, methodID: jmethodID, args: self::Empty) -> jdouble,
  pub CallStaticDoubleMethodA:    extern "C" fn(env: *mut JNIEnv, clazz: jclass, methodID: jmethodID, args: *const jvalue) -> jdouble,
  pub CallStaticVoidMethod:       extern "C" fn(env: *mut JNIEnv, clazz: jclass, methodID: jmethodID, ...),
  pub CallStaticVoidMethodV:      extern "C" fn(env: *mut JNIEnv, clazz: jclass, methodID: jmethodID, args: self::Empty),
  pub CallStaticVoidMethodA:      extern "C" fn(env: *mut JNIEnv, clazz: jclass, methodID: jmethodID, args: *const jvalue),

  /// may throw
  pub GetStaticFieldID:   extern "C" fn(env: *mut JNIEnv, clazz: jclass, name: *const ::libc::c_char, sig: *const ::libc::c_char) -> jfieldID,
  ...
  pub SetStaticObjectField:   extern "C" fn(env: *mut JNIEnv, clazz: jclass, fieldID: jfieldID, val: jobject),
  pub SetStaticBooleanField:  extern "C" fn(env: *mut JNIEnv, clazz: jclass, fieldID: jfieldID, val: jboolean),
  pub SetStaticByteField:     extern "C" fn(env: *mut JNIEnv, clazz: jclass, fieldID: jfieldID, val: jbyte),
  pub SetStaticCharField:     extern "C" fn(env: *mut JNIEnv, clazz: jclass, fieldID: jfieldID, val: jchar),
  pub SetStaticShortField:    extern "C" fn(env: *mut JNIEnv, clazz: jclass, fieldID: jfieldID, val: jshort),
  pub SetStaticIntField:      extern "C" fn(env: *mut JNIEnv, clazz: jclass, fieldID: jfieldID, val: jint),
  pub SetStaticLongField:     extern "C" fn(env: *mut JNIEnv, clazz: jclass, fieldID: jfieldID, val: jlong),
  pub SetStaticFloatField:    extern "C" fn(env: *mut JNIEnv, clazz: jclass, fieldID: jfieldID, val: jfloat),
  pub SetStaticDoubleField:   extern "C" fn(env: *mut JNIEnv, clazz: jclass, fieldID: jfieldID, val: jdouble),
  ...
  pub RegisterNatives:    extern "C" fn(env: *mut JNIEnv, clazz: jclass, methods: *const JNINativeMethod, nMethods: jint) -> JniError,
  pub UnregisterNatives:  extern "C" fn(env: *mut JNIEnv, clazz: jclass) -> JniError,
